...
console.log( producto.slice(0, 10)); // Iniciar en 0 y cortar desde 10
console.log(producto.slice(8));// Cortar desde el 0 hasta el 8
console.log(producto.slice(2, 10)); // cortar desde 2 y desde el 10
